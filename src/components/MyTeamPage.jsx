...
function PendingQueueSection({ deals, loading, onApprove, onReject }) {
  return (
...
function PendingQueueRow({ deal, onApprove, onReject }) {
  const customerName =
    deal.contact_name ||
  ...
  return (
    <li className="bg-page-50 border border-accent-500/30 rounded p-3 md:p-4
                   hover:border-accent-500/60 transition-colors">
