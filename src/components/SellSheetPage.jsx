    ...
    <div className="px-4 md:px-6 lg:px-10 py-4 md:py-6 print:px-0 print:py-0">
      <div className="max-w-6xl mx-auto bg-white print:max-w-none">
        <div className="rounded-3xl overflow-hidden border border-page-200 shadow-card print:shadow-none print:border-0 print:rounded-none">
          <div className="bg-gradient-to-br from-navy-900 via-navy-800 to-accent-700 text-chalk-50 p-6 md:p-8 print:p-6">
            <div className="flex items-start justify-between gap-6">
              <div className="max-w-4xl">
                ...
                <p className="text-sm md:text-base print:text-sm text-chalk-100/90 leading-relaxed max-w-3xl">
                  Ronnoco programs combine equipment, ongoing service, and digital marketing support into one complete program structure built to help create a stronger beverage experience for your customers.
                </p>
              </div>
          ...
          <div className="p-5 md:p-6 print:p-5 space-y-5">
            <section className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-5 print:gap-4">
              <div>
                ...
                <p className="text-sm print:text-[13px] text-slate-700 leading-relaxed mb-4">
                  This program is for customers who want more than equipment alone. It brings together beverage equipment, service, and branded marketing support in one coordinated solution.
                </p>
              ...
              <div className="bg-page-50 border border-page-200 rounded-3xl p-5 print:p-4">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500 mb-2 font-medium">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-5 print:gap-4">
              <div className="bg-accent-500/5 border border-accent-500/20 rounded-3xl p-5 print:p-4">
                ...
                <p className="text-sm print:text-[13px] text-slate-700 leading-relaxed">
              ...
              <div className="bg-white border border-page-200 rounded-3xl p-5 print:p-4">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500 mb-2 font-medium">
                  Best fit
                </p>
                <h2 className="text-2xl print:text-xl font-light text-slate-900 mb-3">
            ...
            <section className="border-t border-page-200 pt-4">
              <p className="text-xs uppercase tracking-[0.18em] text-slate-500 mb-2 font-medium">
                Next step
              </p>
              <p className="text-sm print:text-[13px] text-slate-700 leading-relaxed">
...
function InfoCard({ title, text }) {
  return (
    <div className="rounded-2xl border border-page-200 bg-white p-4 print:p-3">
